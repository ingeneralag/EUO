	...
	return (
		<div className="absolute top-full left-1/2 isolate z-50 flex -translate-x-1/2 justify-center">
			<NavigationMenuPrimitive.Viewport
				...
				className={cn(
					'origin-top bg-background/95 supports-[backdrop-filter]:bg-background/80 text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-3 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-xl border shadow-lg backdrop-blur-xl md:w-[var(--radix-navigation-menu-viewport-width)]',
					className,
				)}
				{...props}
			/>
