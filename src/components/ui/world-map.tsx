...
export function WorldMap({ 
  ...
  const svgMap = useMemo(
    () => {
      if (!map) return null;
      const dotColor = theme === "dark" ? "#ffffff80" : theme === "light" ? "#00000080" : "#64748b80";
      return map.getSVG({
        radius: 0.22,
        color: dotColor,
        shape: "circle",
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-xs font-medium px-1.5 py-0.5 rounded-md bg-white/95 dark:bg-black/95 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
