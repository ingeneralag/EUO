    ...
    >
      ...
      <div className={`relative z-20 flex-1 flex flex-col justify-center items-center text-center ${isMobile
        ...
        >
          ...
          >
            <h1 className={`font-bold leading-tight ${isMobile
              ...
              />
              <br />
              <span className={`bg-gradient-to-r from-primary via-green-600 to-green-400 bg-clip-text text-transparent ${isMobile
          ...
          <motion.p
            ...
            className={`text-muted-foreground dark:text-white/70 max-w-2xl mx-auto leading-relaxed ${isMobile
          ...
          <motion.div
            ...
            className={`flex justify-center items-center ${isMobile
            ...
            <MagneticElement disabled={isMobile}>
              <Link href={`/${currentLocale}/work`}>
                <Button
                  ...
                  className={`font-semibold bg-background/80 backdrop-blur-sm hover:bg-background/90 transition-all duration-300 ${isMobile
          ...
          <motion.div
            ...
            className={`inline-flex items-center gap-2 rounded-full bg-primary/10 border border-primary/20 text-primary font-medium ${isMobile
              ? "mt-6 px-3 py-1.5 text-xs"
              : "mt-8 px-4 py-2 text-sm"
              }`}
          >
            <span className={`bg-green-500 rounded-full animate-pulse ${isMobile ? "w-1.5 h-1.5" : "w-2 h-2"
              }`}></span>
            <span className={isMobile ? "text-xs" : "text-sm"}>
              {t("trusted_by")} {t("countries")}
            </span>
          </motion.div>
        </motion.div>
